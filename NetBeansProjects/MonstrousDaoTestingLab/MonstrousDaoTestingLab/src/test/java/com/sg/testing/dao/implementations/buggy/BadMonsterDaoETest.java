...
public class BadMonsterDaoETest {
    ...
    MonsterDao testDao = new BadMonsterDaoE();
    ...
    @Test
    public void testAddGetMonsterTwice() {
        // Create a monster to test
        Integer monsterId = 0001;
        String name = "Fluffy";
        MonsterType type = YETI;
        ...
        // Check that the data is equal
        assertEquals(myMonster, retrieved, "The monsters should be the same.");
        
        // Get the monster again.
        retrieved = testDao.getMonster(monsterId);
        
        // The monster should still be there and not be null
        assertNotNull(retrieved, "This monster should still be in the Dao.");
    }
