...
package M4.AOP.vendingmachine;

import M4.AOP.vendingmachine.controller.VendingMachineController;
...
//            appContext.scan("M4.AOP.vendingmachine");
//            appContext.refresh();
//            
//            VendingMachineController controller = appContext.getBean("vendingMachineController", VendingMachineController.class);

        // DI from XML
        ApplicationContext appContext = new ClassPathXmlApplicationContext("classpath:VendingMachineAppContext.xml");
