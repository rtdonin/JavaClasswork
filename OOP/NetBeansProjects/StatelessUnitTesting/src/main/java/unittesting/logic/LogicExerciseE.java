...
public class LogicExerciseE {
    ...
    public static String whatColor(int waveLengthNM, int frequencyTHZ, double photonicEnergyEV) {
        ...
        if (waveLengthNM < 450 && waveLengthNM >= 380 && frequencyTHZ > 668 && frequencyTHZ <= 789 && photonicEnergyEV > 2.75 && photonicEnergyEV <= 3.26) {
            color = "Violet";
            ...
            color = "Orange-Red";
        } else if (waveLengthNM < 620 && waveLengthNM >= 750 && frequencyTHZ >= 400 && photonicEnergyEV >= 1.65 && photonicEnergyEV < 2.00) {
            color = "Red";
        } 
